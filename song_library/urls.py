"""
URL configuration for song_library project.
...
urlpatterns = [
    ...
    path('new_song/', profiles_views.new_song, name='new_song'),
    path('song_added', profiles_views.song_added, name='song_added'),
